...
public:
    ...
    void get_data(string modlelName, string fuel, double money, double mil, string transmi, double tank_capa, int seatNo, string airBag)
...
int main()
{
    ...
    while (f)  // loop that continous stroe string till ','.
    {
        ...
        getline(f, model, ','); // getline store string till ',' encountred.
        ...
        car[count].get_data(model, fuel_type_name, pri, mil, transmission, tank, sea, airbag_name);
        count++;
    }
